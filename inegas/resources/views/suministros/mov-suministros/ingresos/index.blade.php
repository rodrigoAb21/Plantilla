                        ...
                        <table class="table table-hover table-striped ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Realizado</td>
                                    <td class="text-right ">
                                        <a href="{{url('sum/mov-suministros/ingresos/1')}}">
                                            <button class="btn btn-outline-primary btn-sm">
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </a>
                                        <button type="button" class="btn btn-outline-primary btn-sm" onclick="eliminarModelo('1', '{{url('sum/mov-suministros/ingresos/1')}}')">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right ">
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm" onclick="eliminarModelo('4', '{{url('sum/mov-suministros/ingresos/1')}}')">
                                            <i class="fa fa-times"></i>
                                        </button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-right ">
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm disabled" onclick="eliminarModelo('7', '{{url('sum/mov-suministros/ingresos/1')}}')">
                                            <i class="fa fa-times"></i>
                                        </button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-right ">
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm" onclick="eliminarModelo('8', '{{url('sum/mov-suministros/ingresos/1')}}')">
                                            <i class="fa fa-times"></i>
                                        </button>
                                    </td>
                                </tr>
