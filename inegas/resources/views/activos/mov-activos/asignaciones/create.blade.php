...
@section('content')
    <form method="POST" action="{{url('act/mov-activos/asignaciones')}}" autocomplete="off">
    <div class="row">
        <div class="col-md-12">
            @if ($errors->any())
            ...
            <div class="card ">
                <div class="card-header card-header-primary card-header-icon">
                    ...
                    <h3 class="card-title">Nueva Asignacion</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                            <div class="form-group mt-2">
                                ...
                                <textarea name="observacion" class="form-control" rows="3" required > {{old('nombre')}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
