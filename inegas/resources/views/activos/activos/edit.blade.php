        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header card-header-primary card-header-icon">
                    ...
                    <h3 class="card-title">Nuevo Activo Fijo</h3>
                </div>
                <form method="POST" action="{{url('act/activos/1')}}" autocomplete="off">
                    <div class="card-body ">
                        {{method_field('patch')}}
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" value="Activo 1">
                                </div>
                            </div>
